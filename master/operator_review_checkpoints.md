...
- Add per-source checkpoint drilldowns to individual Source cards so each source shows its own approved, deferred, dismissed, and needs-review checkpoint history inline.
