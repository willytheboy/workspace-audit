...
import { convergenceReviewSuppressionTest, releaseBuildGateTaskSeedingTest, serverTest, sourceAccessValidationWorkflowTaskSeedingTest, sourceEvidenceCoverageTaskSyncTest } from "./server.test.mjs";
...
const tests = [
  ...
  ["convergenceReviewSuppressionTest", convergenceReviewSuppressionTest],
  ["sourceAccessValidationWorkflowTaskSeedingTest", sourceAccessValidationWorkflowTaskSeedingTest],
