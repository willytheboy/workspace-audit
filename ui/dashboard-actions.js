...
export function createDashboardActionRegistry({ getData, getState, handlers }) {
  ...
  function createStaticActions() {
    ...
    return [
      ...
      {
        id: "save-agent-execution-regression-alert-baseline-ledger-snapshot",
        label: "Save alert baseline snapshot",
        description: "Persist the Agent Execution Regression Alert baseline ledger as a markdown snapshot.",
        category: "Actions",
      ...
      },
      {
        ...
        label: "Checkpoint alert baseline drift",
        description: "Create or update a confirmed checkpoint for the latest Regression Alert baseline snapshot drift.",
        category: "Actions",
