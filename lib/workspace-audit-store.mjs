...
const DEFAULT_STORE = {
  ...
  regressionAlertTaskLedgerSnapshots: [],
  convergenceTaskLedgerSnapshots: [],
  dataSourceHealthSnapshots: [],
  governanceTaskUpdateLedgerSnapshots: [],
  governanceProfileTargetTaskLedgerSnapshots: [],
  ...
  agentExecutionTargetBaselineAuditLedgerSnapshots: [],
  agentExecutionRegressionAlertBaselineLedgerSnapshots: [],
  agentWorkOrderRuns: [],
  convergenceAssimilationRunResults: [],
  convergenceAssimilationRunnerLaunchStackRemediationWorkOrderRunResults: [],
  convergenceAssimilationSessionPacketSnapshots: [],
  convergenceAssimilationRunnerLaunchpadGateSnapshots: [],
  convergenceAssimilationRunnerLaunchAuthorizationPackSnapshots: [],
  convergenceAssimilationRunnerLaunchControlBoardSnapshots: [],
  convergenceAssimilationRunnerLaunchExecutionPacketSnapshots: [],
  convergenceAssimilationRunnerLaunchStackRemediationPackSnapshots: [],
  ...
  cliBridgeHandoffs: [],
  cliBridgeRunnerDryRunSnapshots: [],
  cliBridgeRunTraceSnapshots: [],
  cliBridgeLifecycleHandoffPacketSnapshots: [],
  cliBridgeLifecycleStackRemediationTaskLedgerSnapshots: [],
...
const STORE_KEYS = ["version", "sources", "deploymentSmokeChecks", "releaseCheckpoints", "releaseTaskLedgerSnapshots", "regressionAlertTaskLedgerSnapshots", "convergenceTaskLedgerSnapshots", "dataSourceHealthSnapshots", "governanceTaskUpdateLedgerSnapshots", "governanceProfileTargetTaskLedgerSnapshots", "dataSourceAccessTaskLedgerSnapshots", "agentControlPlaneDecisionTaskLedgerSnapshots", "agentExecutionResultTaskLedgerSnapshots", "dataSourceAccessValidationEvidence", "dataSourceAccessValidationEvidenceSnapshots", "dataSourceAccessValidationWorkflowSnapshots", "convergenceReviews", "findings", "tasks", "workflows", "notes", "milestones", "projectProfiles", "projectProfileHistory", "queueSuppressions", "governanceOperations", "taskSeedingCheckpoints", "scriptRuns", "agentSessions", "agentControlPlaneSnapshots", "agentControlPlaneBaselineSnapshotId", "agentControlPlaneDecisionSnapshots", "agentPolicyCheckpoints", "agentExecutionResultCheckpoints", "agentWorkOrderSnapshots", "agentExecutionSlaLedgerSnapshots", "agentExecutionTargetBaselineAuditLedgerSnapshots", "agentExecutionRegressionAlertBaselineLedgerSnapshots", "agentWorkOrderRuns", "convergenceAssimilationRunResults", "convergenceAssimilationRunnerLaunchStackRemediationWorkOrderRunResults", "convergenceAssimilationSessionPacketSnapshots", "convergenceAssimilationRunnerLaunchpadGateSnapshots", "convergenceAssimilationRunnerLaunchAuthorizationPackSnapshots", "convergenceAssimilationRunnerLaunchControlBoardSnapshots", "convergenceAssimilationRunnerLaunchExecutionPacketSnapshots", "convergenceAssimilationRunnerLaunchStackRemediationPackSnapshots", "convergenceAssimilationRunnerLaunchStackRemediationWorkOrderResultTaskLedgerSnapshots", "convergenceAssimilationRunnerLaunchStackActionTaskLedgerSnapshots", "cliBridgeHandoffs", "cliBridgeRunnerDryRunSnapshots", "cliBridgeRunTraceSnapshots", "cliBridgeLifecycleHandoffPacketSnapshots", "cliBridgeLifecycleStackRemediationTaskLedgerSnapshots", "governanceExecutionViews", "governanceExecutionPolicy", "scanRuns", "meta"];
...
function normalizeStore(parsed) {
  ...
  return {
    ...
    regressionAlertTaskLedgerSnapshots: Array.isArray(objectValue.regressionAlertTaskLedgerSnapshots) ? objectValue.regressionAlertTaskLedgerSnapshots : [],
    convergenceTaskLedgerSnapshots: Array.isArray(objectValue.convergenceTaskLedgerSnapshots) ? objectValue.convergenceTaskLedgerSnapshots : [],
    ...
    governanceProfileTargetTaskLedgerSnapshots: Array.isArray(objectValue.governanceProfileTargetTaskLedgerSnapshots) ? objectValue.governanceProfileTargetTaskLedgerSnapshots : [],
    ...
    agentExecutionTargetBaselineAuditLedgerSnapshots: Array.isArray(objectValue.agentExecutionTargetBaselineAuditLedgerSnapshots) ? objectValue.agentExecutionTargetBaselineAuditLedgerSnapshots : [],
    agentExecutionRegressionAlertBaselineLedgerSnapshots: Array.isArray(objectValue.agentExecutionRegressionAlertBaselineLedgerSnapshots) ? objectValue.agentExecutionRegressionAlertBaselineLedgerSnapshots : [],
    agentWorkOrderRuns: Array.isArray(objectValue.agentWorkOrderRuns) ? objectValue.agentWorkOrderRuns : [],
    convergenceAssimilationRunResults: Array.isArray(objectValue.convergenceAssimilationRunResults) ? objectValue.convergenceAssimilationRunResults : [],
    convergenceAssimilationRunnerLaunchStackRemediationWorkOrderRunResults: Array.isArray(objectValue.convergenceAssimilationRunnerLaunchStackRemediationWorkOrderRunResults) ? objectValue.convergenceAssimilationRunnerLaunchStackRemediationWorkOrderRunResults : [],
    convergenceAssimilationSessionPacketSnapshots: Array.isArray(objectValue.convergenceAssimilationSessionPacketSnapshots) ? objectValue.convergenceAssimilationSessionPacketSnapshots : [],
    convergenceAssimilationRunnerLaunchpadGateSnapshots: Array.isArray(objectValue.convergenceAssimilationRunnerLaunchpadGateSnapshots) ? objectValue.convergenceAssimilationRunnerLaunchpadGateSnapshots : [],
    convergenceAssimilationRunnerLaunchAuthorizationPackSnapshots: Array.isArray(objectValue.convergenceAssimilationRunnerLaunchAuthorizationPackSnapshots) ? objectValue.convergenceAssimilationRunnerLaunchAuthorizationPackSnapshots : [],
    convergenceAssimilationRunnerLaunchControlBoardSnapshots: Array.isArray(objectValue.convergenceAssimilationRunnerLaunchControlBoardSnapshots) ? objectValue.convergenceAssimilationRunnerLaunchControlBoardSnapshots : [],
    convergenceAssimilationRunnerLaunchExecutionPacketSnapshots: Array.isArray(objectValue.convergenceAssimilationRunnerLaunchExecutionPacketSnapshots) ? objectValue.convergenceAssimilationRunnerLaunchExecutionPacketSnapshots : [],
    convergenceAssimilationRunnerLaunchStackRemediationPackSnapshots: Array.isArray(objectValue.convergenceAssimilationRunnerLaunchStackRemediationPackSnapshots) ? objectValue.convergenceAssimilationRunnerLaunchStackRemediationPackSnapshots : [],
    convergenceAssimilationRunnerLaunchStackRemediationWorkOrderResultTaskLedgerSnapshots: Array.isArray(objectValue.convergenceAssimilationRunnerLaunchStackRemediationWorkOrderResultTaskLedgerSnapshots) ? objectValue.convergenceAssimilationRunnerLaunchStackRemediationWorkOrderResultTaskLedgerSnapshots : [],
    convergenceAssimilationRunnerLaunchStackActionTaskLedgerSnapshots: Array.isArray(objectValue.convergenceAssimilationRunnerLaunchStackActionTaskLedgerSnapshots) ? objectValue.convergenceAssimilationRunnerLaunchStackActionTaskLedgerSnapshots : [],
    cliBridgeHandoffs: Array.isArray(objectValue.cliBridgeHandoffs) ? objectValue.cliBridgeHandoffs : [],
    cliBridgeRunnerDryRunSnapshots: Array.isArray(objectValue.cliBridgeRunnerDryRunSnapshots) ? objectValue.cliBridgeRunnerDryRunSnapshots : [],
    cliBridgeRunTraceSnapshots: Array.isArray(objectValue.cliBridgeRunTraceSnapshots) ? objectValue.cliBridgeRunTraceSnapshots : [],
    cliBridgeLifecycleHandoffPacketSnapshots: Array.isArray(objectValue.cliBridgeLifecycleHandoffPacketSnapshots) ? objectValue.cliBridgeLifecycleHandoffPacketSnapshots : [],
    cliBridgeLifecycleStackRemediationTaskLedgerSnapshots: Array.isArray(objectValue.cliBridgeLifecycleStackRemediationTaskLedgerSnapshots) ? objectValue.cliBridgeLifecycleStackRemediationTaskLedgerSnapshots : [],
