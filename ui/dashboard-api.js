...
export const dashboardApi = {
  ...
  /**
   * @param {"all" | "open" | "closed"} [status]
   * @returns {Promise<import("./dashboard-types.js").ConvergenceAssimilationRunnerLaunchControlBoardDriftCheckpointLedgerPayload>}
   */
  fetchConvergenceAssimilationRunnerLaunchControlBoardDriftCheckpointLedger(status = "all") {
    return fetchJson(withQuery("/api/convergence/assimilation-runner-launch-control-board-drift-checkpoint-ledger", { status }));
  },

  /**
   * @param {{ runner?: "codex" | "claude" }} [options]
   * @returns {Promise<import("./dashboard-types.js").ConvergenceAssimilationRunnerLaunchExecutionPacketPayload>}
   */
  fetchConvergenceAssimilationRunnerLaunchExecutionPacket(options = {}) {
    return fetchJson(withQuery("/api/convergence/assimilation-runner-launch-execution-packet", {
      runner: options.runner
    }));
  },

  /**
   * @returns {Promise<import("./dashboard-types.js").PersistedConvergenceAssimilationRunnerLaunchExecutionPacketSnapshot[]>}
   */
  fetchConvergenceAssimilationRunnerLaunchExecutionPacketSnapshots() {
    return fetchJson("/api/convergence/assimilation-runner-launch-execution-packet-snapshots");
  },
  ...
  refreshConvergenceAssimilationRunnerLaunchExecutionPacketSnapshot(payload = {}) {
    return fetchJson("/api/convergence/assimilation-runner-launch-execution-packet-snapshots/refresh", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify(payload)
    });
   ...
   * @param {string} [snapshotId]
   * @param {{ runner?: "codex" | "claude" }} [options]
   * @returns {Promise<import("./dashboard-types.js").ConvergenceAssimilationRunnerLaunchExecutionPacketSnapshotDiffPayload>}
   */
  fetchConvergenceAssimilationRunnerLaunchExecutionPacketSnapshotDiff(snapshotId = "latest", options = {}) {
    return fetchJson(withQuery("/api/convergence/assimilation-runner-launch-execution-packet-snapshots/diff", {
      snapshotId,
      runner: options.runner
    }));
  },
  ...
  checkpointConvergenceAssimilationRunnerLaunchExecutionPacketDrift(payload) {
    return fetchJson("/api/convergence/assimilation-runner-launch-execution-packet-snapshot-drift-checkpoints", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify(payload)
    });
  ...
  /**
   * @param {{ runner?: "codex" | "claude" }} [options]
   * @returns {Promise<import("./dashboard-types.js").ConvergenceAssimilationRunnerLaunchStackRemediationPackPayload>}
   */
  fetchConvergenceAssimilationRunnerLaunchStackRemediationPack(options = {}) {
    return fetchJson(withQuery("/api/convergence/assimilation-runner-launch-stack-remediation-pack", {
      runner: options.runner
    }));
  },
  ...
  /**
   * @param {{ runner?: "codex" | "claude" }} [options]
   * @returns {Promise<import("./dashboard-types.js").ConvergenceAssimilationRunnerLaunchStackRemediationWorkOrderDraftPayload>}
   */
  fetchConvergenceAssimilationRunnerLaunchStackRemediationWorkOrderDraft(options = {}) {
    return fetchJson(withQuery("/api/convergence/assimilation-runner-launch-stack-remediation-work-order-draft", {
      runner: options.runner
    }));
  },
   ...
   */
  refreshConvergenceAssimilationRunnerLaunchStackRemediationPackSnapshot(payload = {}) {
    return fetchJson("/api/convergence/assimilation-runner-launch-stack-remediation-pack-snapshots/refresh", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify(payload || {})
    });
  ...
  /**
   * @param {"all" | "open" | "closed"} [status]
   * @returns {Promise<import("./dashboard-types.js").ConvergenceAssimilationRunnerLaunchStackRemediationPackDriftCheckpointLedgerPayload>}
   */
  fetchConvergenceAssimilationRunnerLaunchStackRemediationPackDriftCheckpointLedger(status = "all") {
    return fetchJson(withQuery("/api/convergence/assimilation-runner-launch-stack-remediation-pack-drift-checkpoint-ledger", { status }));
  },
  ...
  /**
   * @param {{ actions?: import("./dashboard-types.js").ReleaseBuildGateAction[], saveSnapshot?: boolean, captureSnapshot?: boolean, autoCaptureSnapshot?: boolean, snapshotTitle?: string, snapshotStatus?: "all" | "open" | "closed", snapshotLimit?: number, activeProjectId?: string, scopeMode?: "project" | "portfolio" }} [payload]
  ...
  refreshCliBridgeLifecycleHandoffPacketSnapshot(payload = {}) {
    return fetchJson("/api/cli-bridge/lifecycle-handoff-packet-snapshots/refresh", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify(payload || {})
    });
  ...
  /**
   * @returns {Promise<import("./dashboard-types.js").PersistedCliBridgeLifecycleStackRemediationTaskLedgerSnapshot[]>}
   */
  fetchCliBridgeLifecycleStackRemediationTaskLedgerSnapshots() {
    return fetchJson("/api/cli-bridge/lifecycle-stack-remediation-task-ledger-snapshots");
  },

  /**
   * @param {{ title?: string, status?: "all" | "open" | "closed", limit?: number }} [payload]
   * @returns {Promise<{ success: true, snapshot: import("./dashboard-types.js").PersistedCliBridgeLifecycleStackRemediationTaskLedgerSnapshot, cliBridgeLifecycleStackRemediationTaskLedgerSnapshots: import("./dashboard-types.js").PersistedCliBridgeLifecycleStackRemediationTaskLedgerSnapshot[] }>}
   */
  createCliBridgeLifecycleStackRemediationTaskLedgerSnapshot(payload = {}) {
    return fetchJson("/api/cli-bridge/lifecycle-stack-remediation-task-ledger-snapshots", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify(payload || {})
  ...
  /**
   * @returns {Promise<import("./dashboard-types.js").CliBridgeLifecycleStackRemediationTaskLedgerBaselineStatusPayload>}
   */
  fetchCliBridgeLifecycleStackRemediationTaskLedgerBaselineStatus() {
    return fetchJson("/api/cli-bridge/lifecycle-stack-remediation-task-ledger-snapshots/baseline-status");
  },
  ...
  /**
   * @param {{ state?: "all" | "review" | "missing" | "healthy" | "stale" | "drift" | "hold", limit?: number }} [options]
   * @returns {Promise<import("./dashboard-types.js").AgentExecutionRegressionAlertBaselineLedgerPayload>}
   */
  fetchAgentExecutionRegressionAlertBaselineLedger(options = {}) {
    return fetchJson(withQuery("/api/agent-work-order-runs/regression-alert-baseline-ledger", options));
  },
   ...
   */
  fetchAgentExecutionRegressionAlertBaselineLedgerSnapshotDrift(snapshotId) {
    return fetchJson(`/api/agent-work-order-runs/regression-alert-baseline-ledger-snapshots/${encodeURIComponent(snapshotId)}/drift`);
  },
  ...
  refreshAgentWorkOrderRunTargetBaselineAudit(runId, payload = {}) {
    return fetchJson(`/api/agent-work-order-runs/${encodeURIComponent(runId)}/target-baseline-audit-refresh`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify(payload)
    });
  ...
  createGovernanceProfileTargetTasks(payload = {}) {
    return fetchJson("/api/governance/profile-targets/tasks", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify(payload)
    });
